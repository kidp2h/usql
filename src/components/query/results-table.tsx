...
import { ChevronLeft, ChevronRight, Loader2, EyeOff, RotateCcw, Filter, X, ArrowUp, ArrowDown, ArrowUpDown } from "lucide-react";
...
export const ResultsTable = React.memo(function ResultsTable({
  ...
  return (
    <div className={cn("flex flex-col h-full min-h-0 overflow-hidden", className)} {...props}>

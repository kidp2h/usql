...
const TreeView = React.forwardRef<HTMLDivElement, TreeProps>(
    (
        ...
        const [selectedItemIdInternal, setSelectedItemIdInternal] = React.useState<
            string | undefined
        >(initialSelectedItemId)

        const selectedItemId = selectedItemIdProp !== undefined ? selectedItemIdProp : selectedItemIdInternal
        ...
        return (
            <div className={cn('overflow-scroll relative p-2', className)}>
                <TreeItem
                    data={data}
                    ref={ref}
